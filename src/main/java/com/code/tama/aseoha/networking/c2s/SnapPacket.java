/* (C) TAMA Studios 2025 */
package com.code.tama.aseoha.networking.c2s;
...
public class SnapPacket {
	public SnapPacket(FriendlyByteBuf buf) {}
	public SnapPacket() {}
	public void encode() {}
	public void decode() {}

	public static boolean onMessage(SnapPacket message, Supplier<NetworkEvent.Context> ctx) {
		ctx.get().enqueueWork(() -> {

/* (C) TAMA Studios 2025 */
package com.code.tama.aseoha.items.Armor;
...
public class XtonicArmorItem extends ModdedArmorItem {
	public XtonicArmorItem(ArmorMaterial pMaterial, Type pType, Properties pProperties) {
	...
	public @Nullable String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
		return makeCustomTextureLocation(MODID, "xtonic");
	}
}

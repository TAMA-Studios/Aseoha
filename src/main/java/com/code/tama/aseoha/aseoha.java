...
import static com.code.tama.aseoha.blocks.ABlocks.BLOCKS;
import static com.code.tama.aseoha.registries.AItems.FOOD_ITEMS;
import static com.code.tama.aseoha.registries.AItems.ITEMS;
import static com.code.tama.aseoha.registries.ATabs.TABS;
import static com.code.tama.aseoha.registries.ControlRegistry.CONTROLS;

import com.code.tama.aseoha.blocks.Roundels;
import com.code.tama.aseoha.capabilities.Capabilities;
import com.code.tama.aseoha.networking.Networking;
import com.code.tama.aseoha.registries.*;
import com.code.tama.aseoha.tileEntities.ConsoleBlocks;
import com.code.tama.aseoha.tileEntities.ExteriorBlocks;
...
public class aseoha {
	...
	public aseoha() {
		...
		DamageTypes.DAMAGE.register(modEventBus);

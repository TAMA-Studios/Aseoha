...
public class FoodMachineBlock extends Block implements SimpleWaterloggedBlock {
	...
	@NotNull @Override
	public VoxelShape getShape(@NotNull BlockState state, @NotNull BlockGetter worldIn, @NotNull BlockPos pos,
	...
	@NotNull public FluidState getFluidState(BlockState state) {
	...
	public BlockState getStateForPlacement(BlockPlaceContext context) {
		...
		return (BlockState) ((BlockState) Objects.requireNonNull(super.getStateForPlacement(context)).setValue(
				BlockStateProperties.HORIZONTAL_FACING,
				Objects.requireNonNull(context.getPlayer()).getDirection().getOpposite()))
	...
	public @NotNull InteractionResult use(@NotNull BlockState state, @NotNull Level worldIn, @NotNull BlockPos pos,
		...
		if (handIn.equals(InteractionHand.OFF_HAND) || worldIn.isClientSide)
...
//
// public class FoodMachineBlock extends MultiblockBlock implements
// IWaterLoggable {
...
// }
//
// protected void createBlockStateDefinition(StateContainer.Builder<Block,
// BlockState> builder) {
...
// player.displayClientMessage(TardisConstants.Translations.NO_USE_OUTSIDE_TARDIS,
// true);
// }
//
// return ActionResultType.SUCCESS;
...
// TextHelper.createDescriptionItemTooltip(new
// TranslationTextComponent("tooltip.food_machine.desc"));
//
// public FoodMachineBlockItem(Block blockIn,
// MultiblockPatterns.MultiblockPattern pattern, Item.Properties builder)
// {

...
public class HartnellConsoleModel<T extends ConsoleTile> extends BaseTileHierarchicalModel<ConsoleTile>
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			UniversalCommon.modRL("hartnellmodel"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Console = partdefinition.addOrReplaceChild("Console", CubeListBuilder.create(),
				PartPose.offset(0.25F, 16.0F, 0.0F));

		PartDefinition BaseGrid = Console.addOrReplaceChild("BaseGrid", CubeListBuilder.create(),
				PartPose.offset(8.0F, 8.0F, -8.0F));

		PartDefinition cube_r1 = BaseGrid.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-15.75F, -8.5F, -0.5F, 32.0F, 18.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.25F, -9.8F, 8.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r2 = BaseGrid.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-15.75F, -8.5F, -0.5F, 32.0F, 18.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.25F, -9.8F, 8.0F, 0.0F, -2.0944F, 0.0F));

		PartDefinition cube_r3 = BaseGrid.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 0).addBox(-15.75F, -8.5F, -0.5F, 32.0F, 18.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.25F, -9.8F, 8.0F, 0.0F, -1.0472F, 0.0F));

		PartDefinition LowerBasePanels = Console.addOrReplaceChild("LowerBasePanels", CubeListBuilder.create()
				.texOffs(0, 60).addBox(-3.5F, -18.05F, -7.125F, 7.0F, 15.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-0.25F, 8.0F, 0.0F));

		PartDefinition cube_r4 = LowerBasePanels.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 60).addBox(-4.5F, -1.25F, -7.125F, 8.0F, 15.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, 1.0472F, 0.0F));

		PartDefinition cube_r5 = LowerBasePanels.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 60).addBox(-4.5F, -1.25F, -7.125F, 8.0F, 15.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, 2.0944F, 0.0F));

		PartDefinition cube_r6 = LowerBasePanels.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(0, 60).addBox(-4.5F, -1.25F, -7.125F, 8.0F, 15.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r7 = LowerBasePanels.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(0, 60).addBox(-4.5F, -1.25F, -7.125F, 8.0F, 15.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, -2.0944F, 0.0F));

		PartDefinition cube_r8 = LowerBasePanels.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(0, 60).addBox(-4.5F, -1.25F, -7.125F, 8.0F, 15.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, -1.0472F, 0.0F));

		PartDefinition LowerBaseSlants = Console.addOrReplaceChild("LowerBaseSlants", CubeListBuilder.create(),
				PartPose.offset(-0.25F, 8.0F, 0.0F));

		PartDefinition LowerSlant1 = LowerBaseSlants.addOrReplaceChild("LowerSlant1", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r9 = LowerSlant1.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(24, 67).addBox(-8.5F, -0.5F, 2.25F, 17.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -0.6435F, -16.9752F, -0.0436F, 0.0F, 0.0F));

		PartDefinition cube_r10 = LowerSlant1.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(36, 20).addBox(-8.0F, 0.0F, -7.0F, 16.0F, 1.0F, 7.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -3.05F, -7.125F, 0.3054F, 0.0F, 0.0F));

		PartDefinition LowerSlant2 = LowerBaseSlants.addOrReplaceChild("LowerSlant2", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -1.0472F, 0.0F));

		PartDefinition cube_r11 = LowerSlant2.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(24, 67).addBox(-8.5F, -17.284F, 1.5172F, 17.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 16.1565F, -16.9752F, -0.0436F, 0.0F, 0.0F));

		PartDefinition cube_r12 = LowerSlant2.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(36, 20).addBox(-8.0F, -16.0224F, -1.9481F, 16.0F, 1.0F, 7.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 13.75F, -7.125F, 0.3054F, 0.0F, 0.0F));

		PartDefinition LowerSlant3 = LowerBaseSlants.addOrReplaceChild("LowerSlant3", CubeListBuilder.create()
				.texOffs(24, 82).addBox(-8.0F, -0.3935F, -14.25F, 16.0F, 0.0F, 14.0F, new CubeDeformation(0.001F))
				.texOffs(24, 82).addBox(-8.0F, -0.3935F, -0.25F, 16.0F, 0.0F, 14.0F, new CubeDeformation(0.001F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.0944F, 0.0F));

		PartDefinition cube_r13 = LowerSlant3.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(24, 82)
				.addBox(-8.0F, -16.55F, -14.25F, 16.0F, 0.0F, 14.0F, new CubeDeformation(0.002F)).texOffs(24, 82)
		...
		PartDefinition cube_r14 = LowerSlant3.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(24, 82)
						.addBox(-8.0F, -16.55F, -14.25F, 16.0F, 0.0F, 14.0F, new CubeDeformation(0.0F)).texOffs(24, 82)
		...
		PartDefinition cube_r15 = LowerSlant3.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(24, 67).addBox(-8.5F, -17.284F, 1.5172F, 17.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 16.1565F, -16.9752F, -0.0436F, 0.0F, 0.0F));

		PartDefinition cube_r16 = LowerSlant3.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(36, 20).addBox(-8.0F, -16.0224F, -1.9481F, 16.0F, 1.0F, 7.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 13.75F, -7.125F, 0.3054F, 0.0F, 0.0F));

		PartDefinition LowerSlant4 = LowerBaseSlants.addOrReplaceChild("LowerSlant4", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r17 = LowerSlant4.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(24, 67).addBox(-8.5F, -17.284F, 1.5172F, 17.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 16.1565F, -16.9752F, -0.0436F, 0.0F, 0.0F));

		PartDefinition cube_r18 = LowerSlant4.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(36, 20).addBox(-8.0F, -16.0224F, -1.9481F, 16.0F, 1.0F, 7.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 13.75F, -7.125F, 0.3054F, 0.0F, 0.0F));

		PartDefinition LowerSlant5 = LowerBaseSlants.addOrReplaceChild("LowerSlant5", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 2.0944F, 0.0F));

		PartDefinition cube_r19 = LowerSlant5.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(24, 67).addBox(-8.5F, -17.284F, 1.5172F, 17.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 16.1565F, -16.9752F, -0.0436F, 0.0F, 0.0F));

		PartDefinition cube_r20 = LowerSlant5.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(36, 20).addBox(-8.0F, -16.0224F, -1.9481F, 16.0F, 1.0F, 7.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 13.75F, -7.125F, 0.3054F, 0.0F, 0.0F));

		PartDefinition LowerSlant6 = LowerBaseSlants.addOrReplaceChild("LowerSlant6", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 1.0472F, 0.0F));

		PartDefinition cube_r21 = LowerSlant6.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(24, 67).addBox(-8.5F, -17.284F, 1.5172F, 17.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 16.1565F, -16.9752F, -0.0436F, 0.0F, 0.0F));

		PartDefinition cube_r22 = LowerSlant6.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(36, 20).addBox(-8.0F, -16.0224F, -1.9481F, 16.0F, 1.0F, 7.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 13.75F, -7.125F, 0.3054F, 0.0F, 0.0F));

		PartDefinition UpperBaseSlant = Console.addOrReplaceChild("UpperBaseSlant", CubeListBuilder.create(),
				PartPose.offset(-0.25F, 8.0F, 0.0F));

		PartDefinition UpperSlant1 = UpperBaseSlant.addOrReplaceChild("UpperSlant1",
		...
		PartDefinition cube_r23 = UpperSlant1.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(70, 0).addBox(-14.0F, 0.0F, -0.5F, 28.0F, 14.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -22.5662F, -22.9736F, 1.946F, 0.0F, 0.0F));

		PartDefinition cube_r24 = UpperSlant1.addOrReplaceChild("cube_r24",
				CubeListBuilder.create().texOffs(0, 19).addBox(-14.0F, -1.0F, 0.0F, 28.0F, 18.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -21.8684F, -22.7088F, 1.3003F, 0.0F, 0.0F));

		PartDefinition UpperSlant2 = UpperBaseSlant.addOrReplaceChild("UpperSlant2",
				CubeListBuilder.create().texOffs(0, 57)
						.addBox(-14.0F, -23.425F, -24.125F, 28.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(29, 69).addBox(-6.0F, -29.925F, -10.5F, 12.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -1.0472F, 0.0F));

		PartDefinition cube_r25 = UpperSlant2.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(70, 15).addBox(-14.0F, 6.1572F, 15.131F, 28.0F, 14.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -5.7662F, -22.9736F, 1.946F, 0.0F, 0.0F));

		PartDefinition cube_r26 = UpperSlant2.addOrReplaceChild("cube_r26",
				CubeListBuilder.create().texOffs(0, 19).addBox(-14.0F, -5.4896F, 16.189F, 28.0F, 18.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -5.0684F, -22.7088F, 1.3003F, 0.0F, 0.0F));

		PartDefinition UpperSlant3 = UpperBaseSlant.addOrReplaceChild("UpperSlant3", CubeListBuilder.create()
				.texOffs(0, 57).addBox(-14.0F, -23.425F, -24.125F, 28.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(29, 69).addBox(-6.0F, -29.925F, -10.5F, 12.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(69, 106).addBox(-8.0F, -25.3162F, -21.9736F, 5.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.0944F, 0.0F));

		PartDefinition cube_r27 = UpperSlant3.addOrReplaceChild("cube_r27",
				CubeListBuilder.create().texOffs(70, 30).addBox(-14.0F, 6.1572F, 15.131F, 28.0F, 14.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -5.7662F, -22.9736F, 1.946F, 0.0F, 0.0F));

		PartDefinition cube_r28 = UpperSlant3.addOrReplaceChild("cube_r28",
				CubeListBuilder.create().texOffs(0, 19).addBox(-14.0F, -5.4896F, 16.189F, 28.0F, 18.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -5.0684F, -22.7088F, 1.3003F, 0.0F, 0.0F));

		PartDefinition UpperSlant4 = UpperBaseSlant.addOrReplaceChild("UpperSlant4",
				CubeListBuilder.create().texOffs(0, 57)
						.addBox(-14.0F, -23.425F, -24.125F, 28.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(29, 69).addBox(-6.0F, -29.925F, -10.5F, 12.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r29 = UpperSlant4.addOrReplaceChild("cube_r29",
				CubeListBuilder.create().texOffs(70, 45).addBox(-14.0F, 6.1572F, 15.131F, 28.0F, 14.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -5.7662F, -22.9736F, 1.946F, 0.0F, 0.0F));

		PartDefinition cube_r30 = UpperSlant4.addOrReplaceChild("cube_r30",
				CubeListBuilder.create().texOffs(0, 19).addBox(-14.0F, -5.4896F, 16.189F, 28.0F, 18.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -5.0684F, -22.7088F, 1.3003F, 0.0F, 0.0F));

		PartDefinition UpperSlant5 = UpperBaseSlant.addOrReplaceChild("UpperSlant5",
				CubeListBuilder.create().texOffs(0, 57)
						.addBox(-14.0F, -23.425F, -24.125F, 28.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(29, 69).addBox(-6.0F, -29.925F, -10.5F, 12.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 2.0944F, 0.0F));

		PartDefinition cube_r31 = UpperSlant5.addOrReplaceChild("cube_r31",
				CubeListBuilder.create().texOffs(70, 60).addBox(-14.0F, 6.1572F, 15.131F, 28.0F, 14.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -5.7662F, -22.9736F, 1.946F, 0.0F, 0.0F));

		PartDefinition cube_r32 = UpperSlant5.addOrReplaceChild("cube_r32",
				CubeListBuilder.create().texOffs(0, 19).addBox(-14.0F, -5.4896F, 16.189F, 28.0F, 18.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -5.0684F, -22.7088F, 1.3003F, 0.0F, 0.0F));

		PartDefinition UpperSlant6 = UpperBaseSlant.addOrReplaceChild("UpperSlant6",
				CubeListBuilder.create().texOffs(0, 57)
						.addBox(-14.0F, -23.425F, -24.125F, 28.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(29, 69).addBox(-6.0F, -29.925F, -10.5F, 12.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 1.0472F, 0.0F));

		PartDefinition cube_r33 = UpperSlant6.addOrReplaceChild("cube_r33",
				CubeListBuilder.create().texOffs(70, 75).addBox(-14.0F, 6.1572F, 15.131F, 28.0F, 14.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -5.7662F, -22.9736F, 1.946F, 0.0F, 0.0F));

		PartDefinition cube_r34 = UpperSlant6.addOrReplaceChild("cube_r34",
				CubeListBuilder.create().texOffs(0, 19).addBox(-14.0F, -5.4896F, 16.189F, 28.0F, 18.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -5.0684F, -22.7088F, 1.3003F, 0.0F, 0.0F));

		PartDefinition PanelDividers = Console.addOrReplaceChild("PanelDividers", CubeListBuilder.create(),
				PartPose.offset(-0.25F, 8.0F, 0.0F));

		PartDefinition Part1 = PanelDividers.addOrReplaceChild("Part1", CubeListBuilder.create(),
				PartPose.offset(0.0F, -7.0478F, 0.0F));

		PartDefinition cube_r35 = Part1.addOrReplaceChild("cube_r35",
				CubeListBuilder.create().texOffs(43, 43).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 3.0F, 17.0F,
						new CubeDeformation(0.001F)),
				PartPose.offsetAndRotation(-13.8539F, -17.3F, -23.9757F, 0.3054F, 0.5236F, 0.0F));

		PartDefinition Part2 = PanelDividers.addOrReplaceChild("Part2", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -7.0478F, 0.0F, 0.0F, -1.0472F, 0.0F));

		PartDefinition cube_r36 = Part2.addOrReplaceChild("cube_r36",
				CubeListBuilder.create().texOffs(43, 43).addBox(-0.5F, -16.0224F, 5.0519F, 1.0F, 3.0F, 17.0F,
						new CubeDeformation(0.001F)),
				PartPose.offsetAndRotation(-13.8539F, -0.5F, -23.9757F, 0.3054F, 0.5236F, 0.0F));

		PartDefinition Part3 = PanelDividers.addOrReplaceChild("Part3", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -7.0478F, 0.0F, 0.0F, -2.0944F, 0.0F));

		PartDefinition cube_r37 = Part3.addOrReplaceChild("cube_r37",
				CubeListBuilder.create().texOffs(43, 43).addBox(-0.5F, -16.0224F, 5.0519F, 1.0F, 3.0F, 17.0F,
						new CubeDeformation(0.001F)),
				PartPose.offsetAndRotation(-13.8539F, -0.5F, -23.9757F, 0.3054F, 0.5236F, 0.0F));

		PartDefinition Part4 = PanelDividers.addOrReplaceChild("Part4", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -7.0478F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r38 = Part4.addOrReplaceChild("cube_r38",
				CubeListBuilder.create().texOffs(43, 43).addBox(-0.5F, -16.0224F, 5.0519F, 1.0F, 3.0F, 17.0F,
						new CubeDeformation(0.001F)),
				PartPose.offsetAndRotation(-13.8539F, -0.5F, -23.9757F, 0.3054F, 0.5236F, 0.0F));

		PartDefinition Part5 = PanelDividers.addOrReplaceChild("Part5", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -7.0478F, 0.0F, 0.0F, 2.0944F, 0.0F));

		PartDefinition cube_r39 = Part5.addOrReplaceChild("cube_r39",
				CubeListBuilder.create().texOffs(43, 43).addBox(-0.5F, -16.0224F, 5.0519F, 1.0F, 3.0F, 17.0F,
						new CubeDeformation(0.001F)),
				PartPose.offsetAndRotation(-13.8539F, -0.5F, -23.9757F, 0.3054F, 0.5236F, 0.0F));

		PartDefinition Part6 = PanelDividers.addOrReplaceChild("Part6", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -7.0478F, 0.0F, 0.0F, 1.0472F, 0.0F));

		PartDefinition cube_r40 = Part6.addOrReplaceChild("cube_r40",
				CubeListBuilder.create().texOffs(43, 43).addBox(-0.5F, -16.0224F, 5.0519F, 1.0F, 3.0F, 17.0F,
						new CubeDeformation(0.001F)),
				PartPose.offsetAndRotation(-13.8539F, -0.5F, -23.9757F, 0.3054F, 0.5236F, 0.0F));

		PartDefinition UnderconsoleBaseSlant = Console.addOrReplaceChild("UnderconsoleBaseSlant",
				CubeListBuilder.create(), PartPose.offset(-0.25F, 15.5F, 0.0F));

		PartDefinition Slant1 = UnderconsoleBaseSlant.addOrReplaceChild("Slant1", CubeListBuilder.create(),
				PartPose.offset(0.0F, -7.5F, 0.0F));

		PartDefinition cube_r41 = Slant1.addOrReplaceChild("cube_r41",
				CubeListBuilder.create().texOffs(0, 53).addBox(-6.0F, 0.25F, -0.5F, 29.0F, 3.0F, 1.0F,
						new CubeDeformation(-0.01F)),
				PartPose.offsetAndRotation(10.9864F, -22.5434F, -19.029F, -2.6068F, -0.9507F, 2.5124F));

		PartDefinition Slant2 = UnderconsoleBaseSlant.addOrReplaceChild("Slant2", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -7.5F, 0.0F, 0.0F, -1.0472F, 0.0F));

		PartDefinition cube_r42 = Slant2.addOrReplaceChild("cube_r42",
				CubeListBuilder.create().texOffs(0, 53).addBox(-11.7459F, -15.5368F, -0.5F, 29.0F, 3.0F, 1.0F,
						new CubeDeformation(-0.01F)),
				PartPose.offsetAndRotation(10.9864F, -5.7434F, -19.029F, -2.6068F, -0.9507F, 2.5124F));

		PartDefinition Slant3 = UnderconsoleBaseSlant.addOrReplaceChild("Slant3", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -7.5F, 0.0F, 0.0F, -2.0944F, 0.0F));

		PartDefinition cube_r43 = Slant3.addOrReplaceChild("cube_r43",
				CubeListBuilder.create().texOffs(0, 53).addBox(-11.7459F, -15.5368F, -0.5F, 29.0F, 3.0F, 1.0F,
						new CubeDeformation(-0.01F)),
				PartPose.offsetAndRotation(10.9864F, -5.7434F, -19.029F, -2.6068F, -0.9507F, 2.5124F));

		PartDefinition Slant4 = UnderconsoleBaseSlant.addOrReplaceChild("Slant4", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -7.5F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r44 = Slant4.addOrReplaceChild("cube_r44",
				CubeListBuilder.create().texOffs(0, 53).addBox(-11.7459F, -15.5368F, -0.5F, 29.0F, 3.0F, 1.0F,
						new CubeDeformation(-0.01F)),
				PartPose.offsetAndRotation(10.9864F, -5.7434F, -19.029F, -2.6068F, -0.9507F, 2.5124F));

		PartDefinition Slant5 = UnderconsoleBaseSlant.addOrReplaceChild("Slant5", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -7.5F, 0.0F, 0.0F, 2.0944F, 0.0F));

		PartDefinition cube_r45 = Slant5.addOrReplaceChild("cube_r45",
				CubeListBuilder.create().texOffs(0, 53).addBox(-11.7459F, -15.5368F, -0.5F, 29.0F, 3.0F, 1.0F,
						new CubeDeformation(-0.01F)),
				PartPose.offsetAndRotation(10.9864F, -5.7434F, -19.029F, -2.6068F, -0.9507F, 2.5124F));

		PartDefinition Slant6 = UnderconsoleBaseSlant.addOrReplaceChild("Slant6", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -7.5F, 0.0F, 0.0F, 1.0472F, 0.0F));

		PartDefinition cube_r46 = Slant6.addOrReplaceChild("cube_r46",
				CubeListBuilder.create().texOffs(0, 53).addBox(-11.7459F, -15.5368F, -0.5F, 29.0F, 3.0F, 1.0F,
						new CubeDeformation(-0.01F)),
				PartPose.offsetAndRotation(10.9864F, -5.7434F, -19.029F, -2.6068F, -0.9507F, 2.5124F));

		PartDefinition ConsoleCover = Console.addOrReplaceChild("ConsoleCover", CubeListBuilder.create().texOffs(8, 97)
				.addBox(-15.0F, -23.8F, -15.0F, 30.0F, 1.0F, 30.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-0.25F, 8.0F, 0.0F));

		PartDefinition cube_r47 = ConsoleCover.addOrReplaceChild("cube_r47",
				CubeListBuilder.create().texOffs(33, 106).addBox(-6.0F, 9.0F, -12.0F, 12.0F, 1.0F, 9.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, -1.5708F, 1.0472F, 0.0F));

		PartDefinition cube_r48 = ConsoleCover.addOrReplaceChild("cube_r48",
				CubeListBuilder.create().texOffs(33, 106).addBox(-6.0F, 9.0F, -12.0F, 12.0F, 1.0F, 9.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, -1.5708F, 2.0944F, 0.0F));

		PartDefinition cube_r49 = ConsoleCover.addOrReplaceChild("cube_r49",
				CubeListBuilder.create().texOffs(33, 106).addBox(-6.0F, 9.0F, -12.0F, 12.0F, 1.0F, 9.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, -1.5708F, 3.1416F, 0.0F));

		PartDefinition cube_r50 = ConsoleCover.addOrReplaceChild("cube_r50",
				CubeListBuilder.create().texOffs(33, 106).addBox(-6.0F, 9.0F, -12.0F, 12.0F, 1.0F, 9.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, -1.5708F, -2.0944F, 0.0F));

		PartDefinition cube_r51 = ConsoleCover.addOrReplaceChild("cube_r51",
				CubeListBuilder.create().texOffs(33, 106).addBox(-6.0F, 9.0F, -12.0F, 12.0F, 1.0F, 9.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, -1.5708F, -1.0472F, 0.0F));

		PartDefinition cube_r52 = ConsoleCover.addOrReplaceChild("cube_r52",
				CubeListBuilder.create().texOffs(33, 106).addBox(-6.0F, 9.0F, -12.0F, 12.0F, 1.0F, 9.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, -1.5708F, 0.0F, 0.0F));

		PartDefinition TimeRotor = partdefinition.addOrReplaceChild("TimeRotor", CubeListBuilder.create(),
				PartPose.offset(0.0F, 24.75F, 0.0F));

		PartDefinition Glass = TimeRotor.addOrReplaceChild("Glass", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r53 = Glass.addOrReplaceChild("cube_r53",
				CubeListBuilder.create().texOffs(0, 61).addBox(-2.0F, -28.0F, -7.5F, 4.0F, 26.0F, 15.0F,
						new CubeDeformation(0.011F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, 0.5236F, 0.0F));

		PartDefinition cube_r54 = Glass.addOrReplaceChild("cube_r54",
				CubeListBuilder.create().texOffs(0, 61).addBox(-2.0F, -28.0F, -7.5F, 4.0F, 26.0F, 15.0F,
						new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, 1.0472F, 0.0F));

		PartDefinition cube_r55 = Glass.addOrReplaceChild("cube_r55",
				CubeListBuilder.create().texOffs(0, 61).addBox(-2.0F, -28.0F, -7.5F, 4.0F, 26.0F, 15.0F,
						new CubeDeformation(0.011F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r56 = Glass.addOrReplaceChild("cube_r56",
				CubeListBuilder.create().texOffs(0, 61).addBox(-2.0F, -28.0F, -7.5F, 4.0F, 26.0F, 15.0F,
						new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, 2.0944F, 0.0F));

		PartDefinition cube_r57 = Glass.addOrReplaceChild("cube_r57",
				CubeListBuilder.create().texOffs(0, 61).addBox(-2.0F, -28.0F, -7.5F, 4.0F, 26.0F, 15.0F,
						new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r58 = Glass.addOrReplaceChild("cube_r58",
				CubeListBuilder.create().texOffs(0, 61).addBox(-2.0F, -28.0F, -7.5F, 4.0F, 26.0F, 15.0F,
						new CubeDeformation(0.011F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, -0.5236F, 0.0F));

		PartDefinition Rotor = TimeRotor.addOrReplaceChild("Rotor",
				CubeListBuilder.create().texOffs(0, 103)
						.addBox(-3.0F, -31.8F, -3.0F, 6.0F, 3.0F, 6.0F, new CubeDeformation(0.5F)).texOffs(0, 112)
						.addBox(-3.0F, -33.8F, -0.5F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(124, 99)
						.addBox(-0.5F, -41.8F, -0.5F, 1.0F, 28.0F, 1.0F, new CubeDeformation(-0.125F)).texOffs(18, 112)
						.addBox(0.0F, -40.8F, -2.5F, 0.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(10, 114)
						.addBox(-4.0F, -42.8F, -4.0F, 1.0F, 11.0F, 1.0F, new CubeDeformation(-0.125F)).texOffs(10, 114)
						.addBox(3.0F, -42.8F, -4.0F, 1.0F, 11.0F, 1.0F, new CubeDeformation(-0.125F)).texOffs(10, 114)
						.addBox(-0.5F, -42.8F, 3.0F, 1.0F, 11.0F, 1.0F, new CubeDeformation(-0.125F)).texOffs(0, 114)
						.addBox(-4.0F, -33.8F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.25F)).texOffs(0, 114)
						.addBox(3.0F, -33.8F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.25F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition RotorRing = Rotor.addOrReplaceChild("RotorRing", CubeListBuilder.create().texOffs(0, 126)
				.addBox(-2.0F, -34.8F, 3.875F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -1.0F, 0.0F));

		PartDefinition cube_r59 = RotorRing.addOrReplaceChild("cube_r59",
				CubeListBuilder.create().texOffs(0, 126).addBox(-2.0F, -18.0F, 3.875F, 4.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, 0.7854F, 0.0F));

		PartDefinition cube_r60 = RotorRing.addOrReplaceChild("cube_r60",
				CubeListBuilder.create().texOffs(0, 126).addBox(-2.0F, -18.0F, 3.875F, 4.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r61 = RotorRing.addOrReplaceChild("cube_r61",
				CubeListBuilder.create().texOffs(0, 126).addBox(-2.0F, -18.0F, 3.875F, 4.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, 2.3562F, 0.0F));

		PartDefinition cube_r62 = RotorRing.addOrReplaceChild("cube_r62",
				CubeListBuilder.create().texOffs(0, 126).addBox(-2.0F, -18.0F, 3.875F, 4.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r63 = RotorRing.addOrReplaceChild("cube_r63",
				CubeListBuilder.create().texOffs(0, 126).addBox(-2.0F, -18.0F, 3.875F, 4.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r64 = RotorRing.addOrReplaceChild("cube_r64",
				CubeListBuilder.create().texOffs(0, 126).addBox(-2.0F, -18.0F, 3.875F, 4.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r65 = RotorRing.addOrReplaceChild("cube_r65",
				CubeListBuilder.create().texOffs(0, 126).addBox(-2.0F, -18.0F, 3.875F, 4.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, -0.7854F, 0.0F));

		PartDefinition RotorRing2 = Rotor.addOrReplaceChild("RotorRing2", CubeListBuilder.create().texOffs(0, 126)
				.addBox(-2.0F, -34.8F, 3.875F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -8.0F, 0.0F));

		PartDefinition cube_r66 = RotorRing2.addOrReplaceChild("cube_r66",
				CubeListBuilder.create().texOffs(0, 126).addBox(-2.0F, -18.0F, 3.875F, 4.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, 0.7854F, 0.0F));

		PartDefinition cube_r67 = RotorRing2.addOrReplaceChild("cube_r67",
				CubeListBuilder.create().texOffs(0, 126).addBox(-2.0F, -18.0F, 3.875F, 4.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r68 = RotorRing2.addOrReplaceChild("cube_r68",
				CubeListBuilder.create().texOffs(0, 126).addBox(-2.0F, -18.0F, 3.875F, 4.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, 2.3562F, 0.0F));

		PartDefinition cube_r69 = RotorRing2.addOrReplaceChild("cube_r69",
				CubeListBuilder.create().texOffs(0, 126).addBox(-2.0F, -18.0F, 3.875F, 4.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r70 = RotorRing2.addOrReplaceChild("cube_r70",
				CubeListBuilder.create().texOffs(0, 126).addBox(-2.0F, -18.0F, 3.875F, 4.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r71 = RotorRing2.addOrReplaceChild("cube_r71",
				CubeListBuilder.create().texOffs(0, 126).addBox(-2.0F, -18.0F, 3.875F, 4.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r72 = RotorRing2.addOrReplaceChild("cube_r72",
				CubeListBuilder.create().texOffs(0, 126).addBox(-2.0F, -18.0F, 3.875F, 4.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.0F, -0.7854F, 0.0F));
		...
		PartDefinition Throttle = Controls.addOrReplaceChild("Throttle", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r73 = Throttle.addOrReplaceChild("cube_r73",
				CubeListBuilder.create().texOffs(68, 108).addBox(-8.25F, 5.75F, -0.25F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.125F)),
				PartPose.offsetAndRotation(0.25F, -22.5662F, -22.9736F, 1.946F, 0.0F, 0.0F));

		PartDefinition DoorControl = Controls.addOrReplaceChild("DoorControl", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -1.0472F, 0.0F));

		PartDefinition DoorControlTranslate = DoorControl.addOrReplaceChild("DoorControlTranslate",
				CubeListBuilder.create(), PartPose.offset(0.0F, -5.7662F, -22.9736F));

		PartDefinition cube_r74 = DoorControlTranslate
				.addOrReplaceChild("cube_r74",
						CubeListBuilder.create().texOffs(68, 108).addBox(-0.5F, 10.6572F, 15.381F, 1.0F, 1.0F, 1.0F,
								new CubeDeformation(0.125F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.946F, 0.0F, 0.0F));

		PartDefinition Handbrake = Controls.addOrReplaceChild("Handbrake", CubeListBuilder.create(),
				PartPose.offset(0.0F, -5.7662F, -22.9736F));

		PartDefinition cube_r75 = Handbrake.addOrReplaceChild("cube_r75",
				CubeListBuilder.create().texOffs(68, 105).addBox(-3.25F, 5.75F, -0.25F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.125F)),
				PartPose.offsetAndRotation(0.25F, -16.8F, 0.0F, 1.946F, 0.0F, 0.0F));

		PartDefinition MiniLeversPanel1 = Controls.addOrReplaceChild("MiniLeversPanel1", CubeListBuilder.create(),
				PartPose.offset(3.875F, -8.0162F, -18.5361F));

		PartDefinition MiniLever1 = MiniLeversPanel1.addOrReplaceChild("MiniLever1", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.125F, -0.7418F, 0.0F, 0.0F));

		PartDefinition cube_r76 = MiniLever1.addOrReplaceChild("cube_r76", CubeListBuilder.create().texOffs(68, 108)
				.addBox(-0.875F, -1.5206F, 15.4342F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.35F)).texOffs(68, 105)
		...
		PartDefinition MiniLever2 = MiniLeversPanel1.addOrReplaceChild("MiniLever2", CubeListBuilder.create(),
				PartPose.offsetAndRotation(1.0F, 0.0F, 0.125F, 0.9163F, 0.0F, 0.0F));

		PartDefinition cube_r77 = MiniLever2.addOrReplaceChild("cube_r77", CubeListBuilder.create().texOffs(68, 108)
				.addBox(-0.875F, 20.6492F, 4.3807F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.35F)).texOffs(68, 105)
				.addBox(-0.875F, 20.6492F, 5.7557F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)),
				PartPose.offsetAndRotation(0.375F, 2.25F, -4.5625F, 1.946F, 0.0F, 0.0F));

		PartDefinition MiniLever3 = MiniLeversPanel1.addOrReplaceChild("MiniLever3", CubeListBuilder.create(),
				PartPose.offsetAndRotation(2.0F, 0.0F, 0.125F, 0.6109F, 0.0F, 0.0F));

		PartDefinition cube_r78 = MiniLever3.addOrReplaceChild("cube_r78", CubeListBuilder.create().texOffs(68, 108)
				.addBox(-0.875F, 18.5093F, 9.0225F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.35F)).texOffs(68, 105)
				.addBox(-0.875F, 18.5093F, 10.3975F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)),
				PartPose.offsetAndRotation(0.375F, 2.25F, -4.5625F, 1.946F, 0.0F, 0.0F));

		PartDefinition MiniLever4 = MiniLeversPanel1.addOrReplaceChild("MiniLever4", CubeListBuilder.create(),
				PartPose.offsetAndRotation(3.0F, 0.0F, 0.125F, -0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r79 = MiniLever4.addOrReplaceChild("cube_r79", CubeListBuilder.create().texOffs(68, 108)
				.addBox(-0.875F, 4.2068F, 16.5474F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.35F)).texOffs(68, 105)
				.addBox(-0.875F, 4.2068F, 17.9224F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)),
				PartPose.offsetAndRotation(0.375F, 2.25F, -4.5625F, 1.946F, 0.0F, 0.0F));

		PartDefinition MiniLever5 = MiniLeversPanel1.addOrReplaceChild("MiniLever5", CubeListBuilder.create(),
				PartPose.offsetAndRotation(4.0F, 0.0F, 0.125F, -0.8727F, 0.0F, 0.0F));

		PartDefinition cube_r80 = MiniLever5.addOrReplaceChild("cube_r80", CubeListBuilder.create().texOffs(68, 108)
				.addBox(-0.875F, -3.5163F, 14.5141F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.35F)).texOffs(68, 105)
				.addBox(-0.875F, -3.5163F, 15.8891F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)),
				PartPose.offsetAndRotation(0.375F, 2.25F, -4.5625F, 1.946F, 0.0F, 0.0F));

		PartDefinition MiniLeversPanel2 = Controls.addOrReplaceChild("MiniLeversPanel2", CubeListBuilder.create(),
				PartPose.offset(3.625F, -8.0162F, -18.5361F));

		PartDefinition Panel2Rot = MiniLeversPanel2.addOrReplaceChild("Panel2Rot", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-9.625F, 6.5162F, 15.5361F, 0.0F, -1.0472F, 0.0F));

		PartDefinition MiniLever6 = Panel2Rot.addOrReplaceChild("MiniLever6", CubeListBuilder.create(),
				PartPose.offsetAndRotation(3.625F, -8.0162F, -18.4111F, -0.7418F, 0.0F, 0.0F));

		PartDefinition cube_r81 = MiniLever6.addOrReplaceChild("cube_r81", CubeListBuilder.create().texOffs(68, 108)
				.addBox(-0.75F, -1.5206F, 15.4342F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.35F)).texOffs(68, 105)
				.addBox(-0.75F, -1.5206F, 16.8092F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)),
				PartPose.offsetAndRotation(0.375F, 2.25F, -4.5625F, 1.946F, 0.0F, 0.0F));

		PartDefinition MiniLever7 = Panel2Rot.addOrReplaceChild("MiniLever7", CubeListBuilder.create(),
				PartPose.offsetAndRotation(4.625F, -8.0162F, -18.4111F, 0.9163F, 0.0F, 0.0F));

		PartDefinition cube_r82 = MiniLever7.addOrReplaceChild("cube_r82", CubeListBuilder.create().texOffs(68, 108)
				.addBox(-1.0F, 20.6492F, 4.3807F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.35F)).texOffs(68, 105)
				.addBox(-1.0F, 20.6492F, 5.7557F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)),
				PartPose.offsetAndRotation(0.375F, 2.25F, -4.5625F, 1.946F, 0.0F, 0.0F));

		PartDefinition MiniLever8 = Panel2Rot.addOrReplaceChild("MiniLever8", CubeListBuilder.create(),
				PartPose.offsetAndRotation(5.625F, -8.0162F, -18.4111F, 0.6109F, 0.0F, 0.0F));

		PartDefinition cube_r83 = MiniLever8.addOrReplaceChild("cube_r83", CubeListBuilder.create().texOffs(68, 108)
				.addBox(-1.25F, 18.5093F, 9.0225F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.35F)).texOffs(68, 105)
				.addBox(-1.25F, 18.5093F, 10.3975F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)),
				PartPose.offsetAndRotation(0.375F, 2.25F, -4.5625F, 1.946F, 0.0F, 0.0F));

		PartDefinition MiniLever9 = Panel2Rot.addOrReplaceChild("MiniLever9", CubeListBuilder.create(),
				PartPose.offsetAndRotation(6.625F, -8.0162F, -18.4111F, -0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r84 = MiniLever9.addOrReplaceChild("cube_r84", CubeListBuilder.create().texOffs(68, 108)
				.addBox(-1.5F, 4.2068F, 16.5474F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.35F)).texOffs(68, 105)
				.addBox(-1.5F, 4.2068F, 17.9224F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)),
				PartPose.offsetAndRotation(0.375F, 2.25F, -4.5625F, 1.946F, 0.0F, 0.0F));

		PartDefinition MiniLever10 = Panel2Rot.addOrReplaceChild("MiniLever10", CubeListBuilder.create(),
				PartPose.offsetAndRotation(7.625F, -8.0162F, -18.4111F, -0.8727F, 0.0F, 0.0F));

		PartDefinition cube_r85 = MiniLever10.addOrReplaceChild("cube_r85", CubeListBuilder.create().texOffs(68, 108)
				.addBox(-1.75F, -3.5163F, 14.5141F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.35F)).texOffs(68, 105)
				.addBox(-1.75F, -3.5163F, 15.8891F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)),
				PartPose.offsetAndRotation(0.375F, 2.25F, -4.5625F, 1.946F, 0.0F, 0.0F));

		PartDefinition MiniLever11 = Panel2Rot.addOrReplaceChild("MiniLever11", CubeListBuilder.create(),
				PartPose.offsetAndRotation(8.375F, -8.0162F, -18.4111F, -0.8727F, 0.0F, 0.0F));

		PartDefinition cube_r86 = MiniLever11.addOrReplaceChild("cube_r86", CubeListBuilder.create().texOffs(68, 108)
				.addBox(-1.75F, -3.5163F, 14.5141F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.35F)).texOffs(68, 105)
				.addBox(-1.75F, -3.5163F, 15.8891F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)),
				PartPose.offsetAndRotation(0.375F, 2.25F, -4.5625F, 1.946F, 0.0F, 0.0F));

		PartDefinition MiniLeversPanel5 = Controls.addOrReplaceChild("MiniLeversPanel5", CubeListBuilder.create(),
				PartPose.offset(3.625F, -8.0162F, -18.5361F));

		PartDefinition Panel5Rot = MiniLeversPanel5.addOrReplaceChild("Panel5Rot", CubeListBuilder.create(),
				PartPose.offsetAndRotation(3.375F, 6.2662F, 22.2861F, 0.0F, 2.0944F, 0.0F));

		PartDefinition MiniLever12 = Panel5Rot.addOrReplaceChild("MiniLever12", CubeListBuilder.create(),
				PartPose.offsetAndRotation(3.75F, -8.0162F, -18.4111F, -0.7418F, 0.0F, 0.0F));

		PartDefinition cube_r87 = MiniLever12.addOrReplaceChild("cube_r87",
				CubeListBuilder.create().texOffs(68, 108)
						.addBox(-0.5F, -0.5F, -0.4375F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.35F)).texOffs(68, 105)
		...
		PartDefinition MiniLever13 = Panel5Rot.addOrReplaceChild("MiniLever13", CubeListBuilder.create(),
				PartPose.offsetAndRotation(4.0F, -6.6412F, -21.7861F, 0.9163F, 0.0F, 0.0F));

		PartDefinition cube_r88 = MiniLever13.addOrReplaceChild("cube_r88",
				CubeListBuilder.create().texOffs(68, 108)
						.addBox(-0.5F, -0.5F, -0.6875F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.35F)).texOffs(68, 105)
		...
		PartDefinition MiniLever14 = Panel5Rot.addOrReplaceChild("MiniLever14", CubeListBuilder.create(),
				PartPose.offsetAndRotation(4.25F, -5.5162F, -25.0361F, 0.6109F, 0.0F, 0.0F));

		PartDefinition cube_r89 = MiniLever14.addOrReplaceChild("cube_r89",
				CubeListBuilder.create().texOffs(68, 108)
						.addBox(-0.5F, -0.5F, -0.4375F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.35F)).texOffs(68, 105)
						.addBox(-0.5F, -0.5F, 0.9375F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)),
				PartPose.offsetAndRotation(-0.375F, -13.5181F, 9.6576F, 1.946F, 0.0F, 0.0F));

		PartDefinition MiniLever15 = Panel5Rot.addOrReplaceChild("MiniLever15", CubeListBuilder.create(),
				PartPose.offsetAndRotation(6.0F, -5.3912F, -24.7861F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r90 = MiniLever15.addOrReplaceChild("cube_r90", CubeListBuilder.create().texOffs(68, 108)
				.addBox(-1.5F, -2.199F, 15.1566F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.35F)).texOffs(68, 105)
				.addBox(-1.5F, -2.199F, 16.5316F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)),
				PartPose.offsetAndRotation(0.375F, 2.25F, -4.5625F, 1.946F, 0.0F, 0.0F));

		PartDefinition MiniLeverPanel6 = Controls.addOrReplaceChild("MiniLeverPanel6", CubeListBuilder.create(),
				PartPose.offset(3.625F, -8.0162F, -18.5361F));

		PartDefinition Panel5Rot2 = MiniLeverPanel6.addOrReplaceChild("Panel5Rot2", CubeListBuilder.create(),
				PartPose.offsetAndRotation(3.375F, 3.0162F, 22.2861F, 0.0F, 1.0472F, 0.0F));

		PartDefinition MiniLever19 = Panel5Rot2.addOrReplaceChild("MiniLever19", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-5.25F, -21.3466F, -22.4944F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r91 = MiniLever19.addOrReplaceChild("cube_r91",
				CubeListBuilder.create().texOffs(68, 108)
						.addBox(-0.5F, -0.5F, -0.4375F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.35F)).texOffs(68, 105)
						.addBox(-0.5F, -0.5F, 0.9375F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)),
				PartPose.offsetAndRotation(0.0F, 0.2938F, 0.0135F, 1.946F, 0.0F, 0.0F));

		PartDefinition Random = Controls.addOrReplaceChild("Random", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition rando = Random.addOrReplaceChild("rando", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r92 = rando.addOrReplaceChild("cube_r92",
				CubeListBuilder.create().texOffs(68, 101).addBox(2.8333F, 2.9792F, -0.6042F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.125F)),
				PartPose.offsetAndRotation(3.0417F, -24.186F, -19.8275F, 1.946F, 0.0F, 0.0F));

		PartDefinition bone5 = cube_r92.addOrReplaceChild("bone5", CubeListBuilder.create().texOffs(68, 108)
				.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)),
				PartPose.offset(1.3333F, -1.1458F, 0.0208F));

		PartDefinition bone4 = cube_r92.addOrReplaceChild("bone4", CubeListBuilder.create().texOffs(68, 108)
				.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)),
				PartPose.offset(-0.6667F, -1.2708F, 0.0208F));

		PartDefinition bone3 = cube_r92.addOrReplaceChild("bone3", CubeListBuilder.create().texOffs(68, 108)
				.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)),
				PartPose.offset(0.3333F, -0.6458F, 0.0208F));

		PartDefinition bone2 = cube_r92.addOrReplaceChild("bone2", CubeListBuilder.create().texOffs(68, 108)
				.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)),
				PartPose.offset(-1.6667F, -1.0208F, 0.0208F));

		PartDefinition bone = cube_r92.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(68, 105).addBox(-0.5F,
				-0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)),
				PartPose.offset(-2.6667F, -0.3958F, 0.0208F));

		PartDefinition cube_r93 = rando.addOrReplaceChild("cube_r93",
				CubeListBuilder.create().texOffs(68, 108)
						.addBox(5.5F, 14.375F, -9.0986F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.125F)).texOffs(68, 105)
		...
		PartDefinition cube_r94 = rando.addOrReplaceChild("cube_r94",
				CubeListBuilder.create().texOffs(70, 112)
						.addBox(1.625F, 14.5F, -8.8486F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.25F)).texOffs(70, 112)
		...
		PartDefinition cube_r95 = rando.addOrReplaceChild("cube_r95",
				CubeListBuilder.create().texOffs(69, 108)
						.addBox(8.25F, 18.5F, -9.3486F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.125F)).texOffs(69, 108)
						.addBox(7.0F, 18.5F, -9.3486F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.125F)).texOffs(68, 105)
						.addBox(2.625F, 18.75F, -9.0986F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.125F)),
				PartPose.offsetAndRotation(0.0F, -22.5662F, 0.0F, -1.1956F, 2.0944F, 0.0F));

		PartDefinition cube_r96 = rando.addOrReplaceChild("cube_r96",
				CubeListBuilder.create().texOffs(69, 108)
						.addBox(6.625F, 16.5F, -9.3486F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.25F)).texOffs(69, 108)
						.addBox(8.625F, 16.5F, -9.3486F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.25F)).texOffs(69, 108)
		...
		PartDefinition cube_r97 = rando.addOrReplaceChild("cube_r97",
				CubeListBuilder.create().texOffs(68, 105)
						.addBox(4.125F, 19.0F, -9.0986F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.125F)).texOffs(68, 105)
						.addBox(-5.125F, 19.0F, -9.0986F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.125F)),
				PartPose.offsetAndRotation(0.0F, -22.5662F, 0.0F, -1.1956F, -1.0472F, 0.0F));

		PartDefinition randomizer = rando.addOrReplaceChild("randomizer", CubeListBuilder.create(),
				PartPose.offset(0.0F, -22.5662F, 0.0F));

		PartDefinition cube_r98 = randomizer.addOrReplaceChild("cube_r98",
				CubeListBuilder.create().texOffs(68, 105).addBox(6.75F, 18.625F, -9.0986F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.125F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.1956F, -2.0944F, 0.0F));

		PartDefinition fastret = rando.addOrReplaceChild("fastret", CubeListBuilder.create(),
				PartPose.offset(0.0F, -22.5662F, 0.0F));

		PartDefinition cube_r100 = fastret.addOrReplaceChild("cube_r100",
				CubeListBuilder.create().texOffs(68, 108).addBox(-6.75F, 13.5F, -9.0986F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.125F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.1956F, 3.1416F, 0.0F));

		PartDefinition stabs = rando.addOrReplaceChild("stabs", CubeListBuilder.create(),
				PartPose.offset(0.0F, -22.5662F, 0.0F));

		PartDefinition cube_r101 = stabs.addOrReplaceChild("cube_r101",
				CubeListBuilder.create().texOffs(68, 108).addBox(4.75F, 13.5F, -9.0986F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.125F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.1956F, 3.1416F, 0.0F));

		PartDefinition Swivelers = Random.addOrReplaceChild("Swivelers", CubeListBuilder.create(),
				PartPose.offset(3.625F, -8.0162F, -18.5361F));

		PartDefinition Panel2 = Swivelers.addOrReplaceChild("Panel2", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-3.625F, 1.0F, 18.5361F, 0.0F, -1.0472F, 0.0F));

		PartDefinition Swiv1 = Panel2.addOrReplaceChild("Swiv1", CubeListBuilder.create().texOffs(69, 113).addBox(-0.5F,
				-17.3F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-4.75F, -1.25F, -18.0361F));

		PartDefinition SwivCap1 = Swiv1.addOrReplaceChild("SwivCap1", CubeListBuilder.create().texOffs(69, 115)
				.addBox(-0.5F, -17.3F, -0.4375F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.125F)).texOffs(69, 115)
				.addBox(-0.5F, -17.3F, -1.8125F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.25F)),
				PartPose.offset(0.0F, -0.875F, -0.0625F));

		PartDefinition Swiv2 = Panel2.addOrReplaceChild("Swiv2", CubeListBuilder.create().texOffs(69, 113).addBox(-0.5F,
				-17.3F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(4.75F, -1.25F, -18.0361F));

		PartDefinition SwivCap2 = Swiv2.addOrReplaceChild("SwivCap2", CubeListBuilder.create().texOffs(69, 115)
				.addBox(-0.5F, -17.3F, -0.4375F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.125F)).texOffs(69, 115)
				.addBox(-0.5F, -17.3F, -1.8125F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.25F)),
				PartPose.offset(0.0F, -0.875F, -0.0625F));

		PartDefinition Panel5 = Swivelers.addOrReplaceChild("Panel5", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-3.625F, 1.0F, 18.5361F, 0.0F, 2.0944F, 0.0F));

		PartDefinition Swiv3 = Panel5.addOrReplaceChild("Swiv3", CubeListBuilder.create().texOffs(69, 113).addBox(-0.5F,
				-17.3F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-8.125F, 0.0F, -20.6611F));

		PartDefinition SwivCap3 = Swiv3.addOrReplaceChild("SwivCap3", CubeListBuilder.create().texOffs(69, 115)
				.addBox(-0.5F, -17.3F, -0.4375F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.125F)).texOffs(69, 115)
				.addBox(-0.5F, -17.3F, -1.8125F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.25F)),
				PartPose.offsetAndRotation(0.0F, -0.875F, -0.0625F, 0.0F, -0.6109F, 0.0F));

		PartDefinition Swiv4 = Panel5.addOrReplaceChild("Swiv4", CubeListBuilder.create().texOffs(69, 113).addBox(-0.5F,
				-17.3F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-9.625F, 0.125F, -21.4111F));

		PartDefinition SwivCap4 = Swiv4.addOrReplaceChild("SwivCap4", CubeListBuilder.create().texOffs(69, 115)
				.addBox(-0.5F, -17.3F, -0.4375F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.125F)).texOffs(69, 115)
				.addBox(-0.5F, -17.3F, -1.8125F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.25F)),
				PartPose.offsetAndRotation(0.0F, -0.875F, -0.0625F, 0.0F, 1.0472F, 0.0F));

		PartDefinition Swiv5 = Panel5.addOrReplaceChild("Swiv5", CubeListBuilder.create().texOffs(69, 113).addBox(-0.5F,
				-17.3F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-0.875F, -1.875F, -16.7861F));

		PartDefinition SwivCap5 = Swiv5.addOrReplaceChild("SwivCap5", CubeListBuilder.create().texOffs(69, 115)
				.addBox(-0.5F, -17.3F, -0.4375F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.125F)).texOffs(69, 115)
				.addBox(-0.5F, -17.3F, -1.8125F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.25F)),
				PartPose.offsetAndRotation(0.0F, -0.875F, -0.0625F, 0.0F, 1.0472F, 0.0F));

		PartDefinition Swiv6 = Panel5.addOrReplaceChild("Swiv6", CubeListBuilder.create().texOffs(69, 113).addBox(-0.5F,
				-17.3F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.875F, -1.875F, -16.7861F));

		PartDefinition SwivCap6 = Swiv6.addOrReplaceChild("SwivCap6", CubeListBuilder.create().texOffs(69, 115)
				.addBox(-0.5F, -17.3F, -0.4375F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.125F)).texOffs(69, 115)
				.addBox(-0.5F, -17.3F, -1.8125F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.25F)),
				PartPose.offsetAndRotation(0.0F, -0.875F, -0.0625F, 0.0F, -0.4363F, 0.0F));

		PartDefinition Panel6 = Swivelers.addOrReplaceChild("Panel6", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-3.625F, 1.0F, 18.5361F, 0.0F, 1.0472F, 0.0F));

		PartDefinition Swiv8 = Panel6.addOrReplaceChild("Swiv8", CubeListBuilder.create().texOffs(69, 113).addBox(-0.5F,
				-17.3F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-9.375F, 0.125F, -21.1611F));

		PartDefinition SwivCap8 = Swiv8.addOrReplaceChild("SwivCap8", CubeListBuilder.create().texOffs(69, 115)
				.addBox(-0.5F, -17.3F, -0.4375F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.125F)).texOffs(69, 115)
				.addBox(-0.5F, -17.3F, -1.8125F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.25F)),
				PartPose.offsetAndRotation(0.0F, -0.875F, -0.0625F, 0.0F, 0.0436F, 0.0F));

		PartDefinition Swiv7 = Panel6.addOrReplaceChild("Swiv7", CubeListBuilder.create().texOffs(69, 113).addBox(-0.5F,
				-17.3F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-7.375F, 0.125F, -21.1611F));

		PartDefinition SwivCap7 = Swiv7.addOrReplaceChild("SwivCap7", CubeListBuilder.create().texOffs(69, 115)
				.addBox(-0.5F, -17.3F, -0.4375F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.125F)).texOffs(69, 115)
				.addBox(-0.5F, -17.3F, -1.8125F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.25F)),
				PartPose.offsetAndRotation(0.0F, -0.875F, -0.0625F, 0.0F, -0.4363F, 0.0F));

		PartDefinition Swiv9 = Panel6.addOrReplaceChild("Swiv9", CubeListBuilder.create().texOffs(69, 113).addBox(-0.5F,
				-17.3F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.25F, -15.2861F));

		PartDefinition SwivCap9 = Swiv9.addOrReplaceChild("SwivCap9", CubeListBuilder.create().texOffs(69, 115)
				.addBox(-0.5F, -17.3F, -0.4375F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.125F)).texOffs(69, 115)
				.addBox(-0.5F, -17.3F, -1.8125F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.25F)),
				PartPose.offsetAndRotation(0.0F, -0.875F, -0.0625F, 0.0F, 1.0472F, 0.0F));

		PartDefinition Refueller = partdefinition.addOrReplaceChild("Refueller",
				CubeListBuilder.create().texOffs(68, 105).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.125F)),
				PartPose.offsetAndRotation(-5.0F, -0.8799F, -17.7255F, 0.3491F, 0.0F, 0.0F));

		PartDefinition DimensionControl = partdefinition.addOrReplaceChild("DimensionControl", CubeListBuilder.create(),
				PartPose.offset(0.0F, 1.4338F, 0.0F));

		PartDefinition cube_r99 = DimensionControl.addOrReplaceChild("cube_r99",
				CubeListBuilder.create().texOffs(68, 108).addBox(1.0F, 14.375F, -9.0986F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.125F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.1956F, -2.0944F, 0.0F));
	...
	public static class HartnellModelAnimation {
		public static final AnimationDefinition X = AnimationDefinition.Builder.withLength(1.0F)
				.addAnimation("cube_r87",
						new AnimationChannel(AnimationChannel.Targets.ROTATION,
								new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F),
										AnimationChannel.Interpolations.LINEAR),
								new Keyframe(0.5F, KeyframeAnimations.degreeVec(92.5F, 0.0F, 0.0F),
										AnimationChannel.Interpolations.LINEAR),
				...
				.addAnimation("bone2",
						new AnimationChannel(AnimationChannel.Targets.POSITION,
								...
								new Keyframe(0.3333F, KeyframeAnimations.posVec(0.0F, -0.5F, 0.0F),
										AnimationChannel.Interpolations.LINEAR),
								new Keyframe(0.7083F, KeyframeAnimations.posVec(0.0F, 0.5F, 0.0F),
										AnimationChannel.Interpolations.LINEAR),
								new Keyframe(1.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F),
										AnimationChannel.Interpolations.LINEAR)))
				.addAnimation("bone",
		...
		public static final AnimationDefinition FACING = AnimationDefinition.Builder.withLength(0.75F)
				.addAnimation("SwivCap9",
						new AnimationChannel(AnimationChannel.Targets.ROTATION,
								new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F),
										AnimationChannel.Interpolations.LINEAR),
								new Keyframe(0.25F, KeyframeAnimations.degreeVec(0.0F, -62.5F, 0.0F),
										AnimationChannel.Interpolations.LINEAR),
								new Keyframe(0.5F, KeyframeAnimations.degreeVec(0.0F, -260.0F, 0.0F),
										AnimationChannel.Interpolations.LINEAR),
		...
		public static final AnimationDefinition INCREMENT_MODIFIER = AnimationDefinition.Builder.withLength(0.75F)
				.addAnimation("SwivCap6",
						new AnimationChannel(AnimationChannel.Targets.ROTATION,
								new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F),
										AnimationChannel.Interpolations.LINEAR),
								new Keyframe(0.25F, KeyframeAnimations.degreeVec(0.0F, 87.5F, 0.0F),
										AnimationChannel.Interpolations.LINEAR),
								new Keyframe(0.5F, KeyframeAnimations.degreeVec(0.0F, 275.0F, 0.0F),
										AnimationChannel.Interpolations.LINEAR),
								new Keyframe(0.75F, KeyframeAnimations.degreeVec(0.0F, 360.0F, 0.0F),
										AnimationChannel.Interpolations.LINEAR)))
				.build();
				...
				.addAnimation("TimeRotor",
						new AnimationChannel(AnimationChannel.Targets.POSITION,
								...
								new Keyframe(0.5F, KeyframeAnimations.posVec(0.0F, -4.0F, 0.0F),
										AnimationChannel.Interpolations.LINEAR),
								new Keyframe(1.0F, KeyframeAnimations.posVec(0.0F, -6.5F, 0.0F),
										AnimationChannel.Interpolations.LINEAR),
								new Keyframe(1.5F, KeyframeAnimations.posVec(0.0F, -2.5F, 0.0F),
										AnimationChannel.Interpolations.LINEAR),
								new Keyframe(2.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F),
										AnimationChannel.Interpolations.LINEAR)))
				.addAnimation("cube_r56",
						new AnimationChannel(AnimationChannel.Targets.POSITION,
								new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F),
										AnimationChannel.Interpolations.LINEAR)))
				.addAnimation("Rotor",
		...
		public static void animateConditional(ITardisLevel tardis, HartnellConsoleModel<?> model, float ageInTicks) {
			...
			model.getAnyDescendantWithName("Throttle")
					.ifPresent(control -> control.offsetRotation(AnimationHelper.slideBasedOnState(throttle, 142.5F,
							throttle.getPrevious(), throttle.get(), ageInTicks, 20, new Vector3f(1, 0, 0))));

			model.getAnyDescendantWithName("Handbrake").ifPresent(
					control -> control.offsetRotation(new Vector3f(AnimationHelper.slideBasedOnState(handbrake, -42.5F,

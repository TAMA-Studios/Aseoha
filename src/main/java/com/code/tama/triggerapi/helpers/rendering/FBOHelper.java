...
public class FBOHelper {
	...
	// public static final ResourceLocation BLACK = new
	// ResourceLocation(TriggerAPI.getModId(), "textures/black.png"); // TODO: set
	// // RGB
	// // values
	// // when
	// // rendering
	...
	// // sky color
	//
	// public static StencilBufferStorage stencilBufferStorage = new
	// StencilBufferStorage();
	...
	// GlStateManager._glBindFramebuffer(GlConst.GL_READ_FRAMEBUFFER,
	// src.frameBufferId);
	// GlStateManager._glBindFramebuffer(GlConst.GL_DRAW_FRAMEBUFFER,
	// dest.frameBufferId);
	// GlStateManager._glBlitFrameBuffer(0, 0, src.width, src.height, 0, 0,
	...
	// }
	//
	// public static void setRenderTargetColor(RenderTarget src, float r, float g,
	// float b, float a) {
	// src.setClearColor(r, g, b, a);
	// }
	//
	// public void Render(AbstractPortalTile blockEntity, PoseStack stack, int
	// packedLight) {
	...
	//
	// MultiBufferSource.BufferSource botiBuffer =
	// stencilBufferStorage.getConsumer();
	// // TODO: Render Door Frame RIGHT HERE (implement datapack door frames, BOTI
	// mask
	// // named "BOTI")
	//
	// // botiBuffer.endBatch();
	...
	// Minecraft.getInstance().level.getGameTime() : 1)
	// % 600 == 0) {
	...
	// mc.level.registryAccess().registryOrThrow(Registries.DIMENSION_TYPE)
	// .getHolderOrThrow(blockEntity.dimensionTypeId);
	//
	// LevelRenderer renderer = new LevelRenderer(mc,
	// mc.getEntityRenderDispatcher(),
	// mc.getBlockEntityRenderDispatcher(), mc.renderBuffers());
	// ClientLevel level = new ClientLevel(mc.player.connection,
	// mc.level.getLevelData(),
	// blockEntity.targetLevel, dimType, mc.options.getEffectiveRenderDistance(),
	// mc.options.getEffectiveRenderDistance(), mc.level.getProfilerSupplier(),
	// renderer, false, 0);
	...
	// Minecraft.getInstance().level.getSkyColor(blockEntity.targetPos.getCenter(),
	...
	// }
	//
	// public void Render(PoseStack stack, BiConsumer<PoseStack,
	// MultiBufferSource.BufferSource> drawStencil,
	...
	// private final Object2ObjectLinkedOpenHashMap<RenderType, BufferBuilder>
	// typeBufferBuilder = Util
	// .make(new Object2ObjectLinkedOpenHashMap<>(), map -> put(map,
	// getRenderType()));
	//
	// @Getter
	// public final MultiBufferSource.BufferSource consumer =
	// MultiBufferSource.immediateWithBuffers(typeBufferBuilder,
	// new BufferBuilder(256));
	//
	// private static void put(Object2ObjectLinkedOpenHashMap<RenderType,
	// BufferBuilder> builderStorage,
	// RenderType layer) {
	...
	// return RenderType.create("boti",
	// DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP, QUADS, 256, false, true,
	// parameters);
	// }
	// }
}
